...
const emits = defineEmits(['add-success', 'add-failure', 'remove-last-commit'])
...
<template>
  <article
    class="rounded-md px-3 py-2 flex flex-col gap-2 shadow bg-sky-900 bg-gradient-to-b from-sky-800 to-sky-900"
  >
    <div class="flex">
      <div class="flex flex-col grow gap-2 pr-2">
        <p v-if="!titleIsEditable" @click="onTitleClick"
